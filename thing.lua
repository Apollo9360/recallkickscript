...
local Window = OrionLib:MakeWindow({IntroText = "I farted 👏", IntroIcon = "rbxassetid://15315284749",Name = ("Slap Battles 👏".." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
Tab14:AddButton({
	...
	Callback = function()
if game.Players.LocalPlayer.leaderstats.Glove.Value == "Recall" and game.Players.LocalPlayer.Character:FindFirstChild("Recall") and game.Players.LocalPlayer.Character:FindFirstChild("entered") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players[PlayerKick].Character:FindFirstChild("HumanoidRootPart") then
OGL = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
for i,v in pairs(game.Workspace.Lobby.brazil:GetChildren()) do
v.CanTouch = false
end
...
ReplicaPlayer = P00Py165V2
FarmReplicaPlayer = Tab14:AddToggle({
	Name = "Auto Slap Replica Player",
	Default = false,
	Callback = function(Value)
ReplicaFarmPlayer = Value
if game.Players.LocalPlayer.leaderstats.Glove.Value == "Replica" then
if ReplicaFarmPlayer == true then
coroutine.wrap(SpamReplica)()
end
while ReplicaFarmPlayer do
for i, v in pairs(workspace:GetChildren()) do
                if v.Name:match(game.Players.ReplicaPlayer) and v:FindFirstChild("HumanoidRootPart") then
game.ReplicatedStorage.b:FireServer(v:WaitForChild("HumanoidRootPart"),true)
                end
            end
task.wait()
end
elseif ReplicaFarmPlayer == true then
OrionLib:MakeNotification({Name = "Error",Content = "You don't have Replica equipped or you aren't in the island default.",Image = "rbxassetid://7733658504",Time = 5})
wait(0.05)
FarmReplica:Set(false)
end
